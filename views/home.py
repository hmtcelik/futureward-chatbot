...
<div class="demos">
<a class="demo-row reveal d4" href="/comparison" target="_self"><div class="demo-num">01</div><div><div class="demo-title">Side-by-side test</div><p class="demo-desc">The same question goes to two chatbots. The naive one is what platforms like Chatbase produce by default. The other has retrieval, guards, and citations. You'll see exactly when and how the naive one fails.</p></div><div class="demo-link">Open demo<span class="demo-arrow">→</span></div></a>
<a class="demo-row reveal d5" href="/inside" target="_self"><div class="demo-num">02</div><div><div class="demo-title">How it works</div><p class="demo-desc">Every answer with its full forensic trace: what guard fired, what documents were retrieved, what tokens were used, what was caught. The architecture, opened up so anyone can audit it.</p></div><div class="demo-link">Open demo<span class="demo-arrow">→</span></div></a>
<a class="demo-row reveal d6" href="/sync" target="_self"><div class="demo-num">03</div><div><div class="demo-title">Keeping content fresh</div><p class="demo-desc">Talent Taiwan's content updates constantly. This shows the automated pipeline that detects what changed and re-embeds only that. With cost projections at production scale.</p></div><div class="demo-link">Open demo<span class="demo-arrow">→</span></div></a>
</div>
